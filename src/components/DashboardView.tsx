...
interface DashboardViewProps { user: UserProfile; logs: DiagnosticLog[]; onNavigate: (view: ViewMode) => void; accessToken: string | null; onDiagnoseUpload: (upload: UploadedWork) => Promise<void>; }
...
export const DashboardView: React.FC<DashboardViewProps> = ({ user, logs, onNavigate, accessToken, onDiagnoseUpload }) => {
